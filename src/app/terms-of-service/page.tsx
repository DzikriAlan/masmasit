    ...
    <AppShell>
      <div className="mx-auto max-w-3xl px-4 py-12 sm:px-6 lg:px-8">
        <div className="mb-8 flex items-center gap-3">
          ...
          <h1 className="font-display text-3xl font-semibold">{t('Terms of Service', 'Ketentuan Layanan')}</h1>
        </div>
        <div className="prose prose-sm dark:prose-invert max-w-none space-y-6 text-muted-foreground">
          <section>
            <h2 className="font-display text-lg font-semibold text-foreground">{t('Acceptance', 'Penerimaan')}</h2>
          ...
          <section>
            <h2 className="font-display text-lg font-semibold text-foreground">{t('User Responsibilities', 'Tanggung Jawab Pengguna')}</h2>
          ...
          <section>
            <h2 className="font-display text-lg font-semibold text-foreground">{t('Contact', 'Kontak')}</h2>
